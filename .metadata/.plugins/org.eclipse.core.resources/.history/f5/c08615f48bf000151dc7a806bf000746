...
public class RentalManager {
	...
	public void createReservation(Date date, Vehicle v, ArrayList<Equipment> equips, Location location, Account acc)
	{
	...
	public ArrayList<Reservation> searchReservation(Object o)
	{
