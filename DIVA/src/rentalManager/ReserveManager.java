...
public class ReserveManager {
	...
	public void addReservation(Date date, Vehicle vehicle,Equipment[] equips, Location location, Account acc)
	{
	...
	public ArrayList<Reservation> searchReservations(Vehicle v)
	{
		return listOfReservations;
		/*
		tempReservList = new ArrayList<Reservation>();
